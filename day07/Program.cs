...
namespace day07
{
    class Program
    {
        ...
        public static Dictionary<String, List<Rule>> rules = new Dictionary<string, List<Rule>>();
        ...
        public static void Main(string[] args)
        {
            foreach (String line in File.ReadAllLines("input.txt")) {
                ...
                List<Rule> theseRules = new List<Rule>();
        ...
        static int bagsInside(String color) {
            if (!rules.ContainsKey(color)) {
                return 0;
            } else if (rules[color].Count == 0) {
                return 1;
            }

            int result = 1;
            foreach (Rule content in rules[color]) {
